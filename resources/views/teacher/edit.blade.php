            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input class="form-control" type="datetime-local" name="birthday" min="1980-01-01T00:00:00" max="{{ date('Y-m-d\TH:i:s', strtotime('-18 years')) }}"value="{{old('birthday', $emp->teacher->birthday)}}">
                        @error('birthday')
                        <span class="text-danger small">{{$message}}</span>
                        @enderror
                    </div> 
